...
//		public ApiVersionMonitorService(IHttpClientFactory httpClientFactory,
//										ConfigurationService config,
//										ILogger<ApiVersionMonitorService> logger)
//		{
...
//			while (!stoppingToken.IsCancellationRequested)
//			{
//				var healthy = await CheckApiVersionAsync(stoppingToken);
...
//		private async Task<bool> CheckApiVersionAsync(CancellationToken token = default)
//		{
//			try
//			{
