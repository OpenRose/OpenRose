...
{
    /// <inheritdoc />
    public partial class AddRecalculateBaselineItemzDescendantsRollUpEstimationsStoredProcedure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			...
			var sqlFiles = assembly.GetManifestResourceNames().
						Where(file => file.EndsWith("userProcRecalculateBaselineItemzDescendantsRollUpEstimations_202604181917.sql"));
        ...
        {
			var dropuserProcCopyRecordWithChildrenByRecordID = "DROP PROC userProcRecalculateBaselineItemzDescendantsRollUpEstimations";
