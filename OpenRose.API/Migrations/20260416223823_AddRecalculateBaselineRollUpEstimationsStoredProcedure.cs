...
{
    /// <inheritdoc />
    public partial class AddRecalculateBaselineRollUpEstimationsStoredProcedure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			...
			var sqlFiles = assembly.GetManifestResourceNames().
						Where(file => file.EndsWith("userProcRecalculateBaselineRollUpEstimations_202604162034.sql"));
        ...
        {
			var dropuserProcCopyRecordWithChildrenByRecordID = "DROP PROC userProcRecalculateBaselineRollUpEstimations";
