...
{
    /// <inheritdoc />
    public partial class AddSetEstimationUnitForProjectStoredProcedure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			...
			var sqlFiles = assembly.GetManifestResourceNames().
						Where(file => file.EndsWith("userProcSetEstimationUnitForProject_202604101615.sql"));
        ...
        {
			var dropuserProcCopyRecordWithChildrenByRecordID = "DROP PROC userProcSetEstimationUnitForProject";
