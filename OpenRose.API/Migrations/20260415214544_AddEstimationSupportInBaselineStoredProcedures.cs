...
{
    /// <inheritdoc />
    public partial class AddEstimationSupportInBaselineStoredProcedures : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			...
			var sqlFiles = assembly.GetManifestResourceNames().
						Where(file => file.EndsWith("userProcCreateBaselineByExistingBaselineID_202604151733.sql")
						|| file.EndsWith("userProcCreateBaselineByItemzTypeID_202604151741.sql")
						|| file.EndsWith("userProcCreateBaselineByProjectID_202604151737.sql")
						);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
			...
			var sqlFiles = assembly.GetManifestResourceNames().
						Where(file => file.EndsWith("userProcCreateBaselineByExistingBaselineID_202603061922.sql")
						|| file.EndsWith("userProcCreateBaselineByItemzTypeID_202603061821.sql")
						|| file.EndsWith("userProcCreateBaselineByProjectID_202603061820.sql")
						);
			foreach (var sqlFile in sqlFiles)
			{
				using (Stream? stream = assembly.GetManifestResourceStream(sqlFile))
