...
{
    /// <inheritdoc />
    public partial class AddRecalculateProjectRollUpEstimationsStoredProcedure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			...
			var sqlFiles = assembly.GetManifestResourceNames().
						Where(file => file.EndsWith("userProcRecalculateProjectRollUpEstimations_202604091450.sql"));
        ...
        {
			var dropuserProcCopyRecordWithChildrenByRecordID = "DROP PROC userProcRecalculateProjectRollUpEstimations";
