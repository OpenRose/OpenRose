...
{
    /// <inheritdoc />
    public partial class AddRollUpEstimationInCopyStoredProcedures : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			...
			var sqlFiles = assembly.GetManifestResourceNames().
						Where(file => file.EndsWith("userProcCopyRecordWithChildrenByRecordID_202604081655.sql")
						);
